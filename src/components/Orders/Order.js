      ...
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        ...
        <AccordionDetails>
          <div>
            ...
            ?(
              <Typography variant="h6">
              <img src="/Assets/MyOrders/checked.svg" style={{height:"20px", width:"20px"}} alt="checked" />
              <span style={{color:"#5e5e5e"}}>Payment Received</span>
              </Typography>
            )
            :(
            <Typography variant="h6">
            <img src="/Assets/MyOrders/cancel.svg" style={{height:"17px", width:"17px"}} alt="cancel" />
